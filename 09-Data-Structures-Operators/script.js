...
console.log('Wakabi'.padStart(20, '+').padEnd(30, '+'));
...
console.log(maskCreditCard(654374));
console.log(maskCreditCard(6573937273849523));
console.log(maskCreditCard('45362537263828372523'));
